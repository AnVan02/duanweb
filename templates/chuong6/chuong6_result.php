...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['reset'])) {
    if ($attempts < $max_attempts) {
        ...
        $_SESSION['test_completed'] = false;
        header("Location: chuong6_quiz.php?id_test=$id_test&start=1");
        exit();
    }
}
...
<body>
    <div class="container">
        ...
        <?php if (empty($answers) || empty($questions)): ?>
            <p class="no-answers">Bạn chưa trả lời câu hỏi nào! <a class="nav-link" href="chuong6_quiz.php?id_test=<?php echo htmlspecialchars($id_test); ?>&start=1">Quay lại làm bài</a></p>
        <?php else: ?>
