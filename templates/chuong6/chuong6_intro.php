...
// Lấy id_test từ URL
$id_test = isset($_GET['id_test']) ? $_GET['id_test'] : '10';
$ma_khoa = '19';
...
<body>
    <div class="container">
        ...
        <?php if ($recent_result): ?>
            ...
            <div class="navigation-links">
                <a href="chuong6_quiz.php?id_test=<?php echo htmlspecialchars($id_test); ?>&start=1" class="start-quiz<?php echo ($recent_result && $recent_result['so_lan_thu'] >= $max_attempts) ? ' disabled' : ''; ?>">Bắt đầu làm bài</a>
            </div>
        ...
        <?php else: ?>
            ...
            <div class="navigation-links">
                <a href="chuong6_quiz.php?id_test=<?php echo htmlspecialchars($id_test); ?>&start=1" class="start-quiz">Bắt đầu làm bài</a>
            </div>
        <?php endif; ?>
    </div>
</body>
