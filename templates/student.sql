...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 14, 2025 lúc 02:02 PM
...
(1, 10, '71', '2', 3, '20:B;21:A;22:C;23:C;24:B', '20:B;21:A;22:C;23:C;24:B');
...
CREATE TABLE `capbang` (
  `student_id` int(11) NOT NULL,
  `Ten` varchar(255) NOT NULL,
  `khoa_id` varchar(255) NOT NULL,
  `trangthai` int(11) NOT NULL,
  `chung_chi` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, '19', '5', 'Đoạn mã nào dưới đây sẽ in ra màn hình dòng chữ Hello, Python!?', NULL, 'Print(Hello, Python!)', NULL, '', 'print(\"Hello, Python!\")', NULL, '', 'echo \"Hello, Python!\"', NULL, '', 'printf(\"Hello, Python!\")', NULL, '', 'B'),
(2, '19', '5', 'Kết quả của đoạn mã sau là gì?\r\nx = 10\r\ny = \"10\"\r\nprint(x + y)', NULL, '20', NULL, 'Nếu cả hai đều là int thì ra 20, nhưng ở đây y là chuỗi.', '\"1010\"', NULL, 'Nếu x cũng là chuỗi (x = \"10\"), mới được \"1010\"', 'Lỗi', NULL, 'Python không cho phép cộng số nguyên (int) với chuỗi (str) trực tiếp. Dòng x + y sẽ gây ra lỗi TypeError vì hai kiểu dữ liệu khác nhau.', 'None', NULL, 'Không đúng, vì chương trình sẽ bị lỗi chứ không in ra None.', 'C'),
(3, '19', '5', 'Kết quả của đoạn code sau là gì?\r\na = 5\r\nb = 2\r\nprint(a ** b)', NULL, '2.5', NULL, '2.5 là phép chia (5 / 2)', '10', NULL, '10 là phép cộng hoặc nhân không đúng ở đây', '25', NULL, 'Toán tử ** trong Python là lũy thừa. a ** b nghĩa là 5 mũ 2 → 5² = 25.', '32', NULL, '32 là 2 mũ 5, ngược lại với đề', 'A'),
(4, '19', '5', 'Biến nào sau đây là tên biến hợp lệ trong Python?', NULL, '1variable', NULL, '1variable bắt đầu bằng số', '@data', NULL, '@data chứa ký tự không hợp lệ.', 'my_var', NULL, 'my_var là tên biến hợp lệ. Trong Python, tên biến phải bắt đầu bằng chữ cái hoặc dấu gạch dưới (_), và không được trùng với từ khóa.', 'class', NULL, 'class là từ khóa của Python, không thể dùng làm tên biến.', 'C'),
(5, '19', '5', 'Kết quả của đoạn code sau là gì?\r\nx = 7\r\ny = 3\r\nprint(x // y)', NULL, '2.333', NULL, '', '2', NULL, '', '2.0', NULL, '', '3', NULL, '', 'B');
...
(71, 10, 'Bài kiểm tra chương 1', 3, '80', 3),
...
--
ALTER TABLE `ket_qua`
  ADD PRIMARY KEY (`student_id`,`khoa_id`);
...
--
ALTER TABLE `quiz`
  MODIFY `Id_cauhoi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
