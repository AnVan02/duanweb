...
// Lấy kết quả gần nhất
    ...
    $required_pass_percent = 100; // Giá trị mặc định
    $stmt->close();
...
<body>
    ...
    <div class="container">
        <div class="chapter" id="chapter">
         ...
         <div class="content">
            <div class="main">
                <h3>Bài tập môn: <td><?php echo htmlspecialchars($id_khoa); ?></td></h3>
                <h3>Bài test: <td><?php echo htmlspecialchars($ten_test); ?></td></h3>

                <p>Khóa học này cung cấp kiến thức nền tảng về ngôn ngữ lập trình <strong>Python</strong> – ngôn ngữ đơn giản, dễ học và phổ biến trong nhiều lĩnh vực như web, AI, khoa học dữ liệu.</p>
                <ul style="margin=7px; padding:15px ">
                    <li>Biến, kiểu dữ liệu và toán tử</li>
                    <li>Cấu trúc điều khiển: if, for, while</li>
                    <li>Hàm và phạm vi biến</li>
                    <li>Danh sách, tuple, dictionary</li>
                    <li>Xử lý file và nhập xuất cơ bản</li>
                    <li>Lập trình hướng đối tượng cơ bản</li>
                </ul>
                <h4>Đối tượng phù hợp:</h4>
                <p>Sinh viên, người mới bắt đầu học lập trình hoặc chuyển ngành sang công nghệ.</p>

                <p><em>Không cần kinh nghiệm trước đó. Sau khóa học, bạn có thể viết được các chương trình Python cơ bản và sẵn sàng học lên nâng cao.</em></p>
            
            
                <div class="navigation-links" >
                    <a href="chuong4/chuong4_intro.php" class="start-quiz  <?php echo ($recent_result && $recent_result['so_lan_thu'] >= $max_attempts) ? ' disabled' : ''; ?>">Bắt đầu làm bài ➜</a>
                </div>
