        ...
        <div class="content">
            <div class="main">
                ...
                <div class="navigation-links" >
                    <a href="chuong2/chuong2_intro.php" class="start-quiz  <?php echo ($recent_result && $recent_result['so_lan_thu'] >= $max_attempts) ? ' disabled' : ''; ?>">Bắt đầu làm bài ➜</a>
                </div>
                <!-- code -->
                <div class="display">
