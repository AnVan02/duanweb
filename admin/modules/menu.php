...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item <?php if ($action === 'PDF') { echo "active"; } ?>">
            <a class="nav-link" href="index.php?action=PDF&query=PDF">
                <i class="mdi mdi-import menu-icon"></i>
                <span class="menu-title">Upload file pdf</span>
            </a>
        </li>
         ...
         <li class="nav-item <?php if ($action === 'check') { echo "active"; } ?>">
            <a class="nav-link" href="index.php?action=check&query=check">
                ...
                <span class="menu-title">Uplaod video</span>
            </a>
        </li>
        ...
        <li class="nav-item <?php if ($action === 'check') { echo "active"; } ?>">
            <a class="nav-link" href="index.php?action=check&query=check">
                <i class="mdi mdi-account-box-outline menu-icon"></i>
                <span class="menu-title">Update bài tập</span>
            </a>
        </li>
