        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="input-item form-group">
                            ...
                            <input type="text" id="author" name="article_author" class="form-control" value="<?php echo $row['article_author'] ?>">
                        </div>
                        ...
                        <div class="input-item form-group">
                            ...
                            <input type="text" name="article_link" class="form-control" value="<?php echo $row['article_link'] ?>">
                        </div>
                        <div class="input-item form-group">
                            <label for="article_tag">Tab bài viết</label>
                            <input type="text" name="article_tag" class="form-control" value="<?php echo $row['article_tag'] ?>">
                        </div>
                        <div class="input-item form-group">
                            <label for="title">Tiêu đề bài viết</label>
                            <input type="text" name="article_title" class="form-control" value="<?php echo $row['article_title'] ?>">
                        </div>
                        <div class="input-item form-group">
                            <label for="article_content">Nội dung tóm tắt</label>
                            <textarea id="article_content" name="article_content"><?php echo htmlspecialchars($row['article_content']) ?></textarea>
                        </div>
                        <div class="input-item form-group">
                            <label for="article_summary">Nội dung chính bài viết</label>
                            <textarea id="article_summary" name="article_summary"><?php echo htmlspecialchars($row['article_summary']) ?></textarea>
                        </div>
            ...
            <div class="col-lg-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="input-item form-group">
                            <label for="article_status">Trạng thái</label>
                            <select name="article_status" id="article_status" class="form-control">
                                <option value="0" <?php if ($row['article_status'] == 0) echo "selected"; ?>>Bản nháp</option>
                                <option value="1" <?php if ($row['article_status'] == 1) echo "selected"; ?>>Xuất bản</option>
                            </select>
                        </div>
                        <div class="input-item form-group">
                            <label for="image">Hình ảnh</label>
                            <img src="modules/blog/uploads/<?php echo $row['article_image'] ?>" style="width: 100%; height: auto; margin-bottom: 10px;" alt="image">
