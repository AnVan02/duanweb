...
if (isset($_GET['delete'])) {
    ...
    try {
        ...
        $conn->query("DELETE FROM quiz WHERE id_khoa = '$khoa_hoc'");
...
<body>
    <div class="container">
        ...
        <form method="POST">
            ...
            <input type="text" name="id_khoahoc" placeholder="Nhập tên khóa học" value="<?= htmlspecialchars($edit_khoa_hoc) ?>">
            <?php if ($editing): ?>
